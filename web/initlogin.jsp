            ...
            <div class="row">
                ...
                <div class="col-sm-5 col-sm-offset-1">
                    <div class="login-form"><!--login form-->
                        <h2>Account has being created. Please login</h2>
                        <p>Enter your correct credentials<a href="index.jsp" style="color: #0083C9;padding-left: 150px">Home Page</a></p>
                        <%String msg=request.getParameter("err");%>
                        <%String username=request.getParameter("username");%>
                        <label style="color: #ff3333"><%if(msg!=null){%><%=msg%><%}%></label>
                        <form action="login" method="post">
                            <input type="text" name="username" value="<%if(username!=null){%><%=username%><%}%>" placeholder="Enter the User Name"/>
