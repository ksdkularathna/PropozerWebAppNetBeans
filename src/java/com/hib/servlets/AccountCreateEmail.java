 ...
 */
public class AccountCreateEmail extends Thread {
    ...
    public AccountCreateEmail(String receiver) {
        AccountCreateEmail.TO = receiver;
    ...
    public void run() {
        ...
        // Set properties indicating that we want to use STARTTLS to encrypt the connection.
            ...
            String htmlContent = "<html>\n"
                    ...
                    + "\n"
                    + "<tr>\n"
                    + "<th style=\"background-color:#e2335b; color:white;\"><span style=\"font-family:  'Roboto', sans-serif;\"><h1 style=\"padding: 15px 10px 0 10px;\">Welcome to Propozer.LK</h1> </span></th>\n"
                    + "</tr>\n"
                    + "<tr>\n"
                    + "<td><span style=\"color:#e2335b;font-family:  'Roboto', sans-serif;\"> </span></td>\n"
                    + "</tr>\n"
                    + "<tr >\n"
                    + "<td style=\"padding:20px;\"><center> <span style=\"font-size:x-large;\"><span style=\"color:#B0B0B0;\">Thank you, for successfully registering with Propozer.</center></td>\n"
                    + "</tr>\n"
                    + "<tr>\n"
