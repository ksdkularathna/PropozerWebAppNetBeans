 ...
 */
public class verifyEmail extends Thread {
    ...
    public verifyEmail(String receiver, String keycode) {
        verifyEmail.TO = receiver;
    ...
    public void run() {
            ...
            try {
                ...
                msg.setSubject("Welcome to Propozer");
                ...
                String htmlContent = "<html>\n"
                        ...
                        + "\n"
                        + "<tr>\n"
                        + "<th style=\"background-color:#e2335b; color:white;\"><span style=\"font-family:  'Roboto', sans-serif;\"><h1 style=\"padding: 15px 10px 0 10px;\">Propozer.LK Verification</h1> </span></th>\n"
                        + "</tr>\n"
                        + "<tr>\n"
                        ...
                        + "\n"
                        + "<tr >\n"
                        + "<td><span><p>Please use the following verification code for the first login </p> </span></td>\n"
                        + "</tr>\n"
                        + "\n"
                        + "<tr >\n"
                        + "<td style=\"padding:20px;\"><center> <span style=\"font-size:x-large;\"><span style=\"color:#B0B0B0;\">Key Code :</span> "+keycode+"</span></center></td>\n"
                        + "</tr>\n"
                        + "<tr>\n"
