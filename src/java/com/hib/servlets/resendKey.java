 ...
 */
@WebServlet(name = "resendKey", urlPatterns = {"/resendKey"})
public class resendKey extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (username != null) {
            ...
            if(user!=null){                
                verifyEmail email=new verifyEmail(user.getUserName(),user.getPassword().substring(0, 5));
                email.start();
            }
        }
