                                                ...
                                                <div class="row">
                                                    <div class="col-sm-6 ">
                                                        ...
                                                        <div class="field">
                                                            ...
                                                            <input name="email" type="email" value="<%=user.getUserlogin().getUserName()%>" readonly>
                                                            <span class="error"></span> </div>
                                                    ...
                                                    <div class="col-sm-4 ">
                                                        ...
                                                        <div id="profile-pic" class="shipping text-center" style="margin-top: 0px;border: 1px solid #c4c2b9; height: 250px; width: 250px;" ><!--shipping-->
                                                            ...
                                                            <img id="custom_pro_pic" style="height: 100%; width: 100%; object-fit: contain">
                                                        </div>
                                                        
                                                        <div class="field">
                                                            <label class="main"><a data-toggle="modal" href="#myModal" class="btn btn-primary btn-large">Set profile picture</a></label>
        ...
        <script>
            ...
            $('form.idealforms').idealforms({
                ...
                errors: {
                    ...
                    /*'pro_picture': {
                        required: 'Please add your profle picture',
                    },*/
                },
