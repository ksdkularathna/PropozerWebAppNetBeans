        ...
        <div id="wrapper">
                            ...
                            <div id="login-content">
                                ...
                                <form action="login" method="post">
                                    <fieldset id="inputs">
                                        ...
                                        <input id="username" type="text" value="<%=newuser%>" name="username" placeholder="Your Email or User Name" required>
                                        <input id="password" type="password" name="password" placeholder="Password">
                                    </fieldset>
                                    <a style="float: right;" onclick="forget_password()" >Forget password</a>
                                    <fieldset id="actions">
            ...
            <div id="main">
                ...
                <div id="left" style="padding-left: 20px;">
                    <h1 style="font-weight: 400; font-size:22px; ">For a Serious Relationship</h1>
                </div>
                    ...
                    <form action="basicSearch" method="post" class="form form-register">
                        ...
                        <div id="form_fields">
                            ...
                            <p class="legal">
                                ...
                                <br>Become a member to <a href="About.jsp" tabindex="-1">Propozer.lk</a>. <br>
                            </p>
                        ...
                        <tr>
                            <td style="padding-right: 27px;"><img src="images/h1.png" alt="Propozer |Find Your Better Half|" height="118" width="120" data-tooltip="#foo1" >
                                <div class="popup" id="foo1">
                                    Go through the details and spot the best match.
                                </div>
                            </td>
        ...
        <script> // login dropdownmenu
                                        ...
                                        function forget_password() {
                                            swal({
                                                ...
                                                text: 'Enter your username or registered FB profile name in propozer',
                                                type: 'input',
