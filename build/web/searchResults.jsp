...
<html>
    <%
        User search_fields = (User) request.getSession().getAttribute("search_fields");
...
<!-- End Facebook Pixel Code -->
        ...
        <script type="text/javascript">
            ...
            <%if (list != null) {%>
                //alert("<%=search_fields.getCity()%>");
                document.getElementById("city").value = "<%=search_fields.getCity()%>";
                document.getElementById("<%=search_fields.getGender()%>").checked = true;
                document.getElementById("m_status").value = "<%=search_fields.getMaritalStatus()%>";
                document.getElementById("edu_level").value = "<%=search_fields.getEducationLevel()%>";
                document.getElementById("religion").value = "<%=search_fields.getReligion()%>";
                document.getElementById("age_from").value = "<%=search_fields.getFname()%>";
                document.getElementById("age_to").value = "<%=search_fields.getLname()%>";
                document.getElementById("height_from").value = "<%=search_fields.getYourself()%>";
                document.getElementById("height_to").value = "<%=search_fields.getBackground()%>";
                document.getElementById("country").value = "<%=search_fields.getCountry()%>";
                document.getElementById("m_tongue").value = "<%=search_fields.getMothertongue()%>";
            <%}%>
                //alert("done");
            }
            function clearAll() {
            <%if (list != null) {%>
                ...
                document.getElementById("<%=search_fields.getGender()%>").checked = false;
            ...
            function msg() {
                ...
                swal({title: "Sweet!", text: "Before Proposing, Please login to your Propozer Account or <a>Sign Up</a> today!", imageUrl: "images/logo_icon.png"});
            }
        ...
        <section><!--search resultz-->
                            ...
                            <div id="search-box" class="panel-group category-products" style="border: 1px; dotted:#e696aa;">
                                ...
                                <tr><td>Religion</td><td colspan='2'>
                                        <select class='' name='religion' id='religion'>
                                            <option selected="selected" value='Any'>Any</option><option value='Buddhist'>Buddhist
            ...
            <div class="col-sm-9 padding-right" >
                <div class="features_items"><!--features_items-->
                    <%if (list != null) {%>
                    <h2 class="title text-center"><%if (list.size() == 1 || list.size() == 0) {%><%=list.size()%> result found for preference<%} else {%> <%=list.size()%> results found for your preference<%}%></h2>

                    <%
                        for (User results : list) {
                            Boolean proposeStatus = false;
                            Query q1 = hib.session.createQuery("from Userrequests where userId='" + results.getIduser() + "' AND user='" + request.getAttribute("userid") + "'");
                            ...
                            <div class="single-products">
                                <div class="productinfo text-center">
                                    ...
                                    <ul class="nav nav-pills nav-stacked search_box_info">
                                        <table class="table table-condensed total-result" style="margin-bottom: 0px;">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td><li><a href=""><i class="fa fa-arrows-v"></i></i><%=results.getHeight()%> cm</a></li></td>
                                ...
                                <div class="product-overlay" 
                                    ...
                                    <div class="overlay-content"> 
                                        <h5 style="padding-bottom: 5px;">User ID</h5>
                                        <h2 style="padding-bottom: 15px; padding-top: 0px; margin-top: 0px;"><%=results.getUserNameId()%></h2>
